    ...
    <div className="flex flex-col h-screen bg-gray-950 text-gray-100">
      ...
      <header className="sticky top-0 z-10 border-b border-gray-800 bg-gray-900/70 backdrop-blur supports-[backdrop-filter]:bg-gray-900/50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center">
          ...
          <div className="ml-auto flex items-center gap-4">
            <span className="text-sm text-gray-400">Powered by Qwen3</span>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-hidden relative">
        <ScrollArea className="h-full pb-8">
          <div
            className="h-full max-w-5xl mx-auto space-y-6 p-4 sm:p-6 lg:p-8"
            ref={chatAreaRef}
          >
            ...
            {/* ⭐ PHẦN TỬ NEO: Cuộn sẽ luôn trỏ đến đây */}
            <div ref={messagesEndRef} className="h-4 w-full flex-shrink-0" />
          </div>
        </ScrollArea>

        {/* Gradient Fade giữ nguyên */}
        <div className="pointer-events-none absolute bottom-0 inset-x-0 h-32 bg-gradient-to-t from-gray-950 to-transparent" />
      </main>

      {/* FOOTER giữ nguyên */}
      <footer className="border-t border-gray-800 bg-gray-900/70 backdrop-blur supports-[backdrop-filter]:bg-gray-900/50">
